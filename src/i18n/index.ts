import { DEFAULT_LOCALE, type Locale, getLocaleConfig, LOCALE_CODES } from "./config";
import { en, type LocaleMessages } from "./locales/en";
import { sv } from "./locales/sv";

export { DEFAULT_LANGUAGE, DEFAULT_LOCALE, DEFAULT_REGION, type Locale } from "./config";
